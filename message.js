...
$(document).ready(function () {
    ...
    // Fetch the correct flag from flag.json
    $.getJSON('flag.json', function (data) {
        correctFlag10 = data.correctFlag10;
    });

    // Add event listener after loading the modal
    $(document).on('submit', '#flagForm10', function (event) {
        event.preventDefault();
        console.log("Form submitted");
        const flagInput = $('#flagInput10').val();
        console.log("Flag input:", flagInput);

        if (flagInput === correctFlag10) {
            Swal.fire({
                icon: 'success',
                title: 'Congratulations!',
                text: 'You have entered the correct flag!',
...
$(document).ready(function () {
    ...
    // Fetch the correct flag from flag.json
    $.getJSON('flag.json', function (data) {
        correctFlag12 = data.correctFlag12;
    });

    // Add event listener after loading the modal
    $(document).on('submit', '#flagForm12', function (event) {
        event.preventDefault();
        console.log("Form submitted");
        const flagInput = $('#flagInput12').val();
        console.log("Flag input:", flagInput);

        if (flagInput === correctFlag12) {
            Swal.fire({
                icon: 'success',
                title: 'Congratulations!',
                text: 'You have entered the correct flag!',
...
$(document).ready(function () {
    ...
    // Fetch the correct flag from flag.json
    $.getJSON('flag.json', function (data) {
        correctFlag11 = data.correctFlag11;
    });

    // Add event listener after loading the modal
    $(document).on('submit', '#flagForm11', function (event) {
        event.preventDefault();
        console.log("Form submitted");
        const flagInput = $('#flagInput11').val();
        console.log("Flag input:", flagInput);

        if (flagInput === correctFlag11) {
            Swal.fire({
                icon: 'success',
                title: 'Congratulations!',
                text: 'You have entered the correct flag!',
